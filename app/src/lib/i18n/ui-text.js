const uiText = {
  en: {
    ...
    draftText: 'Draft',
    // Geo Collection strings
    geoCollectionInputMethod: 'Select Input Method',
    geoCollectionManualRecording: 'Manual location recording',
    geoCollectionAutomaticRecording: 'Automatic location recording',
    geoCollectionPlacementByTapping: 'Placement by tapping',
    geoCollectionRecordPoint: 'Record a point',
    geoCollectionPause: 'Pause',
    geoCollectionResume: 'Resume',
    geoCollectionClear: 'Clear all',
    geoCollectionSave: 'Save',
    geoCollectionPointCount: 'Points',
    geoCollectionDistance: 'Distance',
    geoCollectionArea: 'Area',
    geoCollectionPerimeter: 'Perimeter',
    geoCollectionInterval: 'Recording Interval',
    geoCollectionAccuracy: 'Accuracy Requirement',
    geoCollectionSeconds: 'seconds',
    geoCollectionMeters: 'meters',
    geoCollectionStartRecording: 'Start Recording',
    geoCollectionStopRecording: 'Stop Recording',
    geoCollectionRecording: 'Recording...',
    geoCollectionWaitingGPS: 'Waiting for GPS accuracy...',
    geoCollectionGPSAccuracy: 'GPS Accuracy',
    geoCollectionMinPointsGeotrace: 'Minimum 2 points required for geotrace',
    geoCollectionMinPointsGeoshape: 'Minimum 3 points required for geoshape',
    geoCollectionDeleteLastPoint: 'Delete last point',
    geoCollectionViewOnMap: 'View on map',
    geoCollectionEdit: 'Edit',
  },
  fr: {
    latitude: 'Latitude',
    longitude: 'Longitude',
    ...
    draftText: 'Brouillon',
    // Geo Collection strings
    geoCollectionInputMethod: "Sélectionner la méthode d'entrée",
    geoCollectionManualRecording: "Enregistrement manuel de l'emplacement",
    geoCollectionAutomaticRecording: "Enregistrement automatique de l'emplacement",
    geoCollectionPlacementByTapping: 'Placement en appuyant',
    geoCollectionRecordPoint: 'Enregistrer un point',
    geoCollectionPause: 'Pause',
    geoCollectionResume: 'Reprendre',
    geoCollectionClear: 'Tout effacer',
    geoCollectionSave: 'Enregistrer',
    geoCollectionPointCount: 'Points',
    geoCollectionDistance: 'Distance',
    geoCollectionArea: 'Superficie',
    geoCollectionPerimeter: 'Périmètre',
    geoCollectionInterval: "Intervalle d'enregistrement",
    geoCollectionAccuracy: 'Exigence de précision',
    geoCollectionSeconds: 'secondes',
    geoCollectionMeters: 'mètres',
    geoCollectionStartRecording: "Commencer l'enregistrement",
    geoCollectionStopRecording: "Arrêter l'enregistrement",
    geoCollectionRecording: 'Enregistrement...',
    geoCollectionWaitingGPS: 'En attente de la précision GPS...',
    geoCollectionGPSAccuracy: 'Précision GPS',
    geoCollectionMinPointsGeotrace: '2 points minimum requis pour geotrace',
    geoCollectionMinPointsGeoshape: '3 points minimum requis pour geoshape',
    geoCollectionDeleteLastPoint: 'Supprimer le dernier point',
    geoCollectionViewOnMap: 'Voir sur la carte',
    geoCollectionEdit: 'Modifier',
  },
};
