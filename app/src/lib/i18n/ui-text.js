const uiText = {
  en: {
    ...
    completeAllRequiredFields: 'Please complete all required fields in all sections before submitting',
  ...
  fr: {
    ...
    mandatoryQuestionsWarning: "Attention: Certaines questions obligatoires ne sont pas encore répondues",
    completeAllRequiredFields: 'Veuillez remplir tous les champs obligatoires de toutes les sections avant de soumettre',
